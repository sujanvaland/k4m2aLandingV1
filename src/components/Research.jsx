    ...
    return (
        <main className="main cc-home cc-research">
                    ...
                    <div className="frontcontainer">
                        <div className="home-hero-header cc-research">
                            <div className="eyebrow-pill">
                                <div className="eyebrow-pill-inner cc-dark">Our Mission</div>
                            </div>
                            <h1 className="home-hero-heading whitetext">Enlightened Humanity</h1>
                        ...
                        <div className="research-intro-wrap">
                            <div className="research-intro-cell">
                                <h2 className="heading-m cc-research whitetext">Global<span className="u-text-sec">Collaboration</span></h2>
                                <div className="research-intro-divider" />
                                <div>Bringing together people with a shared interest in awakening.</div>
                            </div>
                            <div className="research-intro-cell">
                                <h2 className="heading-m cc-research whitetext">Natively<span className="u-text-sec"> Intelligent</span></h2>
                                <div className="research-intro-divider" />
                                <div>Smart features that guide your path and simplify your journey.</div>
                            </div>
                            <div className="research-intro-cell cc-last maxw300">
                                <h2 className="heading-m cc-research whitetext">Always<span className="u-text-sec"> Accessible</span></h2>
                                <div className="research-intro-divider" />
            ...
            <section className="section">
                <div className="page-padding enlightened">
                    <div className="frontcontainer">
                        <div className="section-header cc-research">
                            <div className="eyebrow-pill">
                                <div className="eyebrow-pill-inner">What we’re building</div>
                    ...
                    <div className="frontcontainer">
                        <div className="research-join-wrap">
                            <div id="w-node-_5c3689c3-0a5e-8aab-85ab-ed6cf790ecfd-24e32e33" className="research-join-content">
                                <div className="eyebrow-pill">
                                    <div className="eyebrow-pill-inner">Join K4M2A</div>
                                    <div className="eyebrow-pill-bg u-rainbow u-blur-perf" />
                                </div>
                                ...
                                <EmailForm classNameNote="textleft marleft10 phonetextright" isCreator={false} />
                ...
                <div className="page-padding">
                    <div className="frontcontainer">
                        <div className="home-hero-header cc-research-dev">
                            <h2 className="section-heading whitetext">Content Creators</h2>
                            ...
                            <div className='creatorform'>
                                <EmailForm classNameNote="textleft marleft10 phonetextright" isCreator />
                            </div>
                            <span className="cta cc-mt w-inline-block">
                                <div className="cta-inner cc-dark">Request Creator Access</div>
                            </span>
                        </div>
                        <div className="research-intro-wrap c-dev">
                            <div className="research-intro-cell cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">Spiritual Audience Only</h2>
                                    <div className="research-intro-divider" />
                            ...
                            <div className="research-intro-cell cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">Creator Tools Suite</h2>
                                    <div className="research-intro-divider" />
                            ...
                            <div className="research-intro-cell cc-last cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">No Algorithm Bias</h2>
                                    <div className="research-intro-divider" />
                            ...
                            <div className="research-intro-cell cc-last cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">Diverse Media Support</h2>
                                    <div className="research-intro-divider" />
                            ...
                            <div className="research-intro-cell cc-last cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">Intent-Based Discovery</h2>
                                    <div className="research-intro-divider" />
                            ...
                            <div className="research-intro-cell cc-last cc-dev">
                                ...
                                <div>
                                    <h2 className="heading-m cc-research whitetext">Collaborative Creation</h2>
                                    <div className="research-intro-divider" />
