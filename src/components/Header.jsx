...
export default function Header() {
  ...
  return (
    <nav className={`nav ${isResearchPage ? 'blacknav' : ''} ${isMenuOpen ? 'open' : ''}`}>
        ...
        <div className="frontcontainer">
          <div className="nav-inner">
            <div className="nav-left">
              <Link to="/" className="nav-logo" onClick={(e) => handleClick(e, '/')}>
                <div className="svg-embed cc-logo-word">
                  {isResearchPage ? (
                    <>
                      <img alt="logo" src="/images/logo-main-wh.svg" className="whitelogo desktop" loading="lazy" />
                      <img src="/images/logo.png" alt="K4M2A" className="menumobile" loading="lazy" />
                    </>
                  ) : (
                    <img src="/images/logo.png" alt="K4M2A" loading="lazy" />
                  )}
                </div>
              </Link>
              <div role="button" tabIndex="0" className="nav-menu" onClick={(e) => handleClick(e, '/')}>
                <Link to="/" className={`nav-link ${location.pathname === '/' ? 'w--current' : ''}`}>
                  Home
                </Link>
                <Link
                  to="/manifesto"
                ...
                {/* <Link
                  to="/career"
                  className={`nav-link ${location.pathname === '/career' ? 'w--current' : ''}`}
                ...
                <Link
                  to="/security"
                  className={`nav-link ${location.pathname === '/security' ? 'w--current' : ''}`}
                ...
                <Link
                  to="/whatisk4m2a"
                  className={`nav-link ${location.pathname === '/whatisk4m2a' ? 'w--current' : ''}`}
                ...
                <Link
                  to="/blog"
                  className={`nav-link ${location.pathname.startsWith('/blog') ? 'w--current' : ''}`}
            ...
            <div className="nav-right">
              ...
              <button type="button" className="nav-mobile-btn" onClick={toggleMenu} aria-label="Toggle menu">
                <div className="hamburger_1_wrap" aria-hidden="true">
                  <div className="hamburger_1_line" />
                  <div className="hamburger_embed w-embed" style={{ height: 7, position: 'relative' }} />
                  <div className="hamburger_1_line" />
                </div>
              </button>
            </div>
          ...
          <div className="frontcontainer">
            <div className="mobile-menu-inner">
              <div className="mobile-menu-fade">
                <Link
                  to="/"
                  className={`nav-mobile-link ${location.pathname === '/' ? 'w--current' : ''}`}
              ...
              <div className="mobile-menu-fade">
                <Link
                  to="/manifesto"
                  className={`nav-mobile-link ${location.pathname === '/manifesto' ? 'w--current' : ''}`}
              ...
              <div className="mobile-menu-fade">
                <Link
                  to="/research"
                  className={`nav-mobile-link ${location.pathname === '/research' ? 'w--current' : ''}`}
              ...
              {/* <div className="mobile-menu-fade">
                <Link
                  to="/career"
                  className={`nav-mobile-link ${location.pathname === '/career' ? 'w--current' : ''}`}
              ...
              <div className="mobile-menu-fade">
                <Link
                  to="/security"
                  className={`nav-mobile-link ${location.pathname === '/security' ? 'w--current' : ''}`}
              ...
              <div className="mobile-menu-fade">
                <Link
                  to="/whatisk4m2a"
                  className={`nav-mobile-link ${location.pathname === '/whatisk4m2a' ? 'w--current' : ''}`}
              ...
              <div className="mobile-menu-fade">
                <Link
                  to="/blog"
                  className={`nav-mobile-link ${location.pathname.startsWith('/blog') ? 'w--current' : ''}`}
              ...
              */ }
              ...
              <div className="mobile-menu-fade">
                ...
                {/* <Link
                  ...
                  className={`nav-mobile-link cc-small ${location.pathname === '/terms' ? 'w--current' : ''} `}
                >
                  Terms of Use
                </Link> */}
                <Link
                  onClick={(e) => handleClick(e, "/whatisk4m2a", true)}
                  to="/whatisk4m2a"
                  className={`nav-mobile-link cc-small ${location.pathname === "/whatisk4m2a" ? "w--current" : ""
                    }`}
                >
                  What is K4M2A?
                </Link>
                <Link
                  ...
                  to="/rules"
                  className={`nav-mobile-link cc-small ${location.pathname === '/rules' ? 'w--current' : ''} `}
                >
                  Play by the Rules
                </Link>
                      ...
                      <div className="svg-embed w-embed">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            ...
                            fill="#212121"
                          />
                          <path d="M12.7891 8.241L18.6818 1.5H22.2443L14.4391 10.4265L12.7891 8.241Z" fill="#212121" />
                          <path
