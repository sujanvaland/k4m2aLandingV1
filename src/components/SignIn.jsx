...
function SignIn() {
  ...
  return (
    <div className="websitepage">
      <div className="login-frontcontainer loginpagebox">
        <div className="left-panel">
          <div className="content">
            <Link to="/"> <img src="/images/logo-main-wh.svg" className="whitelogo desktop small-logo" /></Link>
            <img
            ...
            <div className="logincntBox">
              ...
              <ul role="list" className="steps-list cc-research w-list-unstyled">
                <li className="list-item"><div className="list-item-icon">
                ...
                <li className="list-item"><div className="list-item-icon"><div className="svg-embed w-embed">
                ...
                <li className="list-item"><div className="list-item-icon">
                  <div className="svg-embed w-embed"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 0.805664C5.373 0.805664 0 6.17866 0 12.8057C0 19.4327 5.373 24.8057 12 24.8057C18.627 24.8057 24 19.4327 24 12.8057C23.981 6.18666 18.619 0.824664 12 0.805664ZM19.207 8.51266L10.207 17.5127C10.012 17.7077 9.756 17.8057 9.5 17.8057C9.244 17.8057 8.988 17.7077 8.793 17.5127L4.793 13.5127C4.402 13.1217 4.402 12.4897 4.793 12.0987C5.184 11.7077 5.816 11.7077 6.207 12.0987L9.5 15.3917L17.793 7.09866C18.184 6.70766 18.816 6.70766 19.207 7.09866C19.598 7.48966 19.598 8.12166 19.207 8.51266Z" fill="#B0B0B0"></path></svg>
          ...
          <main className="main cc-home">
            ...
            <div className="manifesto-hero-img-wrap">
              ...
              <div className="hero cc-manifesto">
                <img src="/images/logo.png" className="deviceLogo" />
                <div className="page-padding">
                  <div className="frontcontainer">
                    {isForgotpassword ? (
                      <div className="manifesto-header">
                        <h1 className="home-hero-heading">Forgot Password</h1>
                      </div>
                    ) : (
                      <div className="manifesto-header">
                      ...
                      <ul>
                        <li>
                          <input
                            type="text"
                            name="emailOrPhone"
                            className={`form-control input ${errors.emailOrPhone ? "input-error" : ""
                              }`}
                        ...
                        <li className="button-center">
                          <button
                            ...
                            disabled={loading}
                          >
                            {loading ? "Signing in" : "Send"}
                          </button>
                        </li>
                      </ul>
                      <div className="formmfields centertext martop50">
                    ...
                    <form onSubmit={handleSubmit}>
                      <ul>
                        ...
                        <li>
                          ...
                          {
                            formData.password != '' &&
                            <button type="button" className="btnshowpassword" onClick={showpassword}>
                        ...
                        <li className="forgotpass">
                          <button type="button" onClick={goForgotpassword}>
                            {' '}
                            Forgot password?
                          </button>
                        </li>
                      ...
                      <div className='formfields'>
                        <Link to="/" className="btnbacklink">Back to Home</Link>
                      </div>
