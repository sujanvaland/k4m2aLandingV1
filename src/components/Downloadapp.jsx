                    ...
                    <div className="main-profilecontainer container">
...

                        {
                            ...
                            <div className="leftdownload">
                                <h1 className="home-hero-heading">Connect from <br />anywhere</h1>
                                <p className="subheading">You can connect anytime, anywhere with <br />the k4m2a
                                ...
                                <div className="appmainbox">
                                    ...
                                    <div className="iosbox appbox">
                                        <a href="https://apps.apple.com/in/app/k4m2a/id6743112577" target="_blank"
                                            rel="noopener noreferrer">
